...
export default function EcoregionsLayer() {
  ...
  if (ecoregionsLayer && source) {
    ...
    return new CartoSQLLayer({
      ...
      getFillColor: (object) => getRGBvalue(object.properties.us_l4name, ecoregionsLayer.selectedStore ),
      getLineColor:(object) => getLineColorFunc(object.properties.us_l4name, ecoregionsLayer.selectedStore ),
      getLineWidth:(object) => getLineWidthFunc(object.properties.us_l4name, ecoregionsLayer.selectedStore ),
      lineWidthScale: 1,
